...
const Footer: React.FC = () => {
  return (
    <footer className="bg-[#0A0A0A] text-gray-400 py-4 border-t border-gray-700/20">
      <div className="container mx-auto px-4">
        <div className="flex flex-col sm:flex-row justify-between items-center">
          {/* Copyright - Left side on desktop */}
          <p className="text-xs text-gray-500 mb-4 sm:mb-0">&copy; {new Date().getFullYear()} SpeedType • A modern typing practice website</p>
